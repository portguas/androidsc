...
public class ShareClass {
    ...
    private void CreateShare(String title,String content ,Activity activity,ResolveInfo appInfo) {
        ...
        try
        {
            ...
            shareIntent.setComponent(new ComponentName("jp.naver.line.android", "jp.naver.line.android.activity.selectchat.SelectChatActivity"));
            //这里就是组织内容了，
