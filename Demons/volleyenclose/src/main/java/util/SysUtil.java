...
public class SysUtil {
    ...
    public static String getUid() {
        if (TextUtils.isEmpty(sUid)) {
            String uid = null;
            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(VolleyApp.getInstance().getContext());
            if (sp != null) {
    ...
    public static String getCountryCode() {
        String code = getSimCountry(VolleyApp.getInstance().getContext());
    ...
    private static Context getContext() {
        return VolleyApp.getInstance().getContext();
    }
